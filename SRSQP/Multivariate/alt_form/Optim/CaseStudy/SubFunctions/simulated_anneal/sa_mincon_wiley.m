...
Temp_xlb = -optParams.P_feas.b(1:Nx);
Temp_xub = optParams.P_feas.b(Nx+1:end);
x_lb = repmat(Temp_xlb,NL,1);
x_ub = repmat(Temp_xub,NL,1);
...
Lb = repmat([x_lb;u_lb],2,1);
Ub = repmat([x_ub;u_ub],2,1);
...
% All constraints
function [g,geq]=constraints(x,optParams)
% Inequality constraints


% Equality constraints
[g,geq] = confun_case(x,optParams);
%% End of the program ------------------------------------------------
